...
#define STRING_CONFIG_H_AUTHOR "(AndersSahlman, QQ-S config, updated by duskyme)" // Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT,  DEFAULT_XYZ_STEPS_PER_UNIT, 418.5 }  // default steps per unit
